...
$reportDir = Join-Path $repoRoot "builds\qa\storybot"
New-Item -ItemType Directory -Force -Path $reportDir | Out-Null
$logPath = Join-Path $reportDir "story_auto_qa_latest.log"
...
$startedAt = Get-Date
$arguments = @("--path", $projectPath, "--script", "res://tests/story_auto_qa_runner.gd", "--log-file", $logPath)
